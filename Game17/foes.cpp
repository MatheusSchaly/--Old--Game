...
// Shows the map's messages, creates the foes' interactions:

std::string territoryMessage (int foeNumber, int territory, int &life) {
            ...
            switch (foeNumber) {
                ...
                case 2:
                    ...
                    if (fightOrFlee == "fight") {
                        do {
                            giantAction = randomizeUpToFiveWords ("He threw you seven meters away, and you hit a tree", "He punched you right in your face", "0", "0", "0");
                            if (giantAction == "He threw you seven meters away, and you hit a tree") {
                                damage ()
                            }
                        } while (giantLife > 0);
                    }
