...
void ambushCombat (int &life, int &foeLife) {
    ...
    std::vector<std::string> words7, words8, characterPenaltyText, foePenaltyText;
    ...
    characterDamage = randomizeNumber(10) + 4;
    foeDamage = randomizeNumber(10) + 4;
    ...
    if (action < 11) {
        ...
        if (answer == "tumble") {
            ...
            if (action < 7) {
                ...
                foeDamageChanged = foeDamage * 15;
                characterPenalty.push_back(6);
                characterPenaltyText.push_back("Shattered chest");
                characterPenaltyTextQuantity.push_back(1);
                receivesDamagePenalty(foeDamageChanged, life, foePenalty, foePenaltyText, foePenaltyTextQuantity);
            }
            else {
                std::cout << "You incredibly parried a giant sword with your sword (surprising everyone). Then smashed his knee with a kick, breaking it.\n";
                characterDamageChanged = characterDamage * 30;
                foePenalty.push_back(9);
        ...
        if (life > 0 && foeLife > 0) {
            ...
            std::cout << "Try to evade with your body. And cut his in the neck thereafter. / Try to shift his sword's trajectory using your knife, and cut his neck thereafter. Choose: \n";
            action = randomizeNumber(10);....
        }
    }
    else {
