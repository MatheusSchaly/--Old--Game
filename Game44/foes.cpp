...
void receivesDamageAndPenalty (int foeDamage, int &life, std::vector <int> foePenalty, std::vector <std::string> foePenaltyText, std::vector <int> foePenaltyTextQuantity) {
...
void dealsDamageAndPenalty (int characterDamage, int &foesLife, std::vector <int> characterPenalty, std::vector <std::string> characterPenaltyText, std::vector <int> characterPenaltyTextQuantity) {
