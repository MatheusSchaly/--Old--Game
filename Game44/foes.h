...
void receivesDamageAndPenalty (int foeDamage, int &life, std::vector <int> foePenalty, std::vector <std::string> foePenaltyText, std::vector <int> foePenaltyTextQuantity); // Informs the damage done by the foe, deals with penalties, and reduces your life.
void dealsDamageAndPenalty (int characterDamage, int &foesLife, std::vector <int> characterPenalty, std::vector <std::string> characterPenaltyText, std::vector <int> characterPenaltyTextQuantity); // Informs the damage done by you, deals with penalties, and reduces the foes' life.
...
void ambushTalk (int &life); // Ambush talk.
void ambushCombat (int &life); // Ambush man combat.
