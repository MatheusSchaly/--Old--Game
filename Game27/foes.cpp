...
void foeInteraction (int foeNumber, int territory, int &life) {
    ...
    std::vector <std::string> fightFlee, words1;
        ...
        case 3:
            switch (foeNumber) {
                ...
                case 2:
                    ...
                    fightFlee = {"fight", "flee"};
                    fightOrFlee = checkWords (2, fightFlee);
                    std::cout << std::endl;
                    while (giantLife > 0 && life > 0 && fightOrFlee == "fight") {
                        if (fightOrFlee == "fight") {
                            words1 = {"He tries to grab you, ", "He tries to seize you, "};
                            prob1 = {50, 50};
                            giantAction = randomizeWordsWithProbability (2, prob1, words1);
                        }
