...
void receivesDamage (int foeDamage, int &life, std::vector <int> foePenalty, std::vector <std::string> foePenaltyText, std::vector <int> foePenaltyTextQuantity); // Informs the damage done by the foe, and reduces the character's life.
void dealsDamage (int characterDamage, int &foesLife, std::vector <int> characterPenalty, std::vector <std::string> characterPenaltyText, std::vector <int> characterPenaltyTextQuantity); // Informs the damage done by you, and reduces the foes' life.
